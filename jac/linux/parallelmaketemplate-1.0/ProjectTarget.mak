...
#终级目标信赖项
TargetDepend := $(ProjectDependList) $(ProjectFolders) folders chmods $(notdir $(GCHDepend)) $(notdir $(GCH)) objects $(TargetName)
...
.PHONY : all clean debug release $(ProjectDependList) folders chmods objects
