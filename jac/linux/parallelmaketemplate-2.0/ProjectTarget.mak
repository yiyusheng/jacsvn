...
#终级目标信赖项
TargetDepend := $(ProjectDependList) folders chmods $(notdir $(GCHDepend)) $(notdir $(GCH)) objects $(AllObjects) $(TargetName)
...
.PHONY : all clean debug release $(ProjectDependList) folders chmods depends objects $(AllObjects)

clean :
	@echo Project:$(ProjectName) clean
	-rm -f $(AllObjects) $(patsubst %,%.*,$(AllObjects)) $(AllDepends) $(patsubst %,%.*,$(AllDepends)) $(TargetPath) $(GCH)
